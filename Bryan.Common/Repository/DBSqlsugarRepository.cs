...
namespace Bryan.Common.Repository
{
    ...
    {
        public SqlSugarClient SqlSugarDB { get => DBManager.GetInstance(); }
        ...
        /// <param name="where">查找条件</param>
        /// <returns>一条记录</returns>
        public TResult GetEntity<TResult>(Expression<Func<T, bool>> where, Expression<Func<T, TResult>> select)
        {
        ...
        /// <returns></returns>
        public T GetEntity(Expression<Func<T, bool>> where, Expression<Func<T, object>> orderBy, bool isDesc = false)
        {
            if (isDesc)
        ...
        /// <returns></returns>
        public TResult GetEntity<TResult, T2>(Expression<Func<T, T2, object[]>> express, Expression<Func<TResult, bool>> where, Expression<Func<T, T2, TResult>> obj)
        {
        ...
        /// <param name="where"></param>
        /// <returns></returns>
        public bool IsAny(Expression<Func<T, bool>> where)
        {
        ...
        /// <returns></returns>
        public List<T> GetList(Expression<Func<T, bool>> where, Expression<Func<T, object>> orderBy, bool isDesc = false)
        {
            if (isDesc)
        ...
        /// <param name="orderByType"></param>
        /// <returns></returns>
        public List<T> GetList(Expression<Func<T, bool>> where, string orderBy)
        {
        ...
        /// <param name="orderByType"></param>
        /// <returns></returns>
        public List<object> GetList(Expression<Func<T, bool>> where, Expression<Func<T, object>> obj, Expression<Func<T, object>> orderBy, bool isDesc = false)
        {
            if (isDesc)
        ...
        public List<TResult> GetList<TResult, T2>(Expression<Func<T, T2, object[]>> express, Expression<Func<TResult, bool>> where, Expression<Func<T, T2, TResult>> obj, Expression<Func<TResult, object>> orderBy, bool isDesc = false)
        {
            if (isDesc)
        ...
        /// <param name="orderBy"></param>
        /// <returns></returns>
        public List<object> GetList(Expression<Func<T, bool>> where, Expression<Func<T, object>> obj, string orderBy)
        {
            return SqlSugarDB.Queryable<T>().Where(where).OrderBy(orderBy).Select(obj).ToList();
        }

        public List<TResult> GetListByTake<TResult>(Expression<Func<T, bool>> where, Expression<Func<T, TResult>> obj, string orderBy, int num)
        {
            return SqlSugarDB.Queryable<T>().Where(where).OrderBy(orderBy).Select(obj).Take(num).ToList();
        }

        public List<T> GetListByTake(Expression<Func<T, bool>> where, string orderBy, int num)
        {
        ...
        /// <returns></returns>
        public PageList<T> GetPageList(Expression<Func<T, bool>> where, PageSet pageSet, Expression<Func<T, object>> orderBy, bool isDesc = false, bool isPageNavStr = false)
        {
            if (pageSet == null)
            {
        ...
        /// <param name="isPageNavStr"></param>
        /// <returns></returns>
        public PageList<T> GetPageList(Expression<Func<T, bool>> where, PageSet pageSet, string orderBy, bool isPageNavStr = false)
        {
            if (pageSet == null)
            {
                pageSet = new PageSet() { PageIndex = 1, PageSize = 100000 };
        ...
        /// <param name="isPageNavStr"></param>
        /// <returns></returns>
        public PageList<TResult> GetPageList<TResult>(Expression<Func<T, bool>> where, PageSet pageSet, Expression<Func<T, TResult>> obj, Expression<Func<T, object>> orderBy, bool isDesc = false, bool isPageNavStr = false)
        {
            if (pageSet == null)
            {
                pageSet = new PageSet() { PageIndex = 1, PageSize = 100000 };
        ...
        /// <param name="isPageNavStr"></param>
        /// <returns></returns>
        public PageList<TResult> GetPageList<TResult>(Expression<Func<T, bool>> where, PageSet pageSet, Expression<Func<T, TResult>> obj, string orderBy, bool isPageNavStr = false)
        {
            if (pageSet == null)
            {
                pageSet = new PageSet() { PageIndex = 1, PageSize = 100000 };
        ...
        /// <param name="isPageNavStr"></param>
        /// <returns></returns>
        public PageList<TResult> GetPageList<TResult, T2>(Expression<Func<T, T2, object[]>> express, Expression<Func<TResult, bool>> where, PageSet pageSet, Expression<Func<T, T2, TResult>> obj, Expression<Func<TResult, object>> orderBy, bool isDesc = false, bool isPageNavStr = false)
        {
            if (pageSet == null)
            {
                pageSet = new PageSet() { PageIndex = 1, PageSize = 100000 };
        ...
        public int GetMaxValue(Expression<Func<T, bool>> where, Expression<Func<T, int>> filed)
        {
            return SqlSugarDB.Queryable<T>().Where(where).Max(filed);
        }

        public TResult GetOneKey<TResult>(Expression<Func<T, bool>> where, Expression<Func<T, TResult>> filed)
        {
        ...
        /// <returns></returns>
        public int Update(T updateObj, bool isLock = false)
        {
        ...
        /// <returns></returns>
        public int UpdateColumns(Expression<Func<T, object>> updateColumns, T updateObj, bool isLock = false)
        {
            if (isLock)
        ...
        /// <param name="where"></param>
        /// <returns></returns>
        public int UpdateColumns(Expression<Func<T, object>> updateColumns, Expression<Func<T, bool>> where)
        {
        ...
        /// <param name="isLock">是否加锁</param>
        /// <returns></returns>
        public int UpdateIgnoreColumns(Expression<Func<T, object>> ignoreColumns, T updateObj, bool isLock = false)
        {
            if (isLock)
        ...
        /// <returns></returns>
        public int UpdateList(List<T> updateList)
        {
        ...
        /// <returns></returns>
        public int DeleteById(dynamic id, bool isLock = false)
        {
            if (isLock)
        ...
        /// <returns></returns>
        public int Insert(T insertObj, bool isReturnId = false)
        {
            if (isReturnId)
        ...
        /// <param name="insertObj"></param>
        /// <returns></returns>
        public long InsertGetId(T insertObj)
        {
        ...
        /// <param name="insertObj"></param>
        /// <returns></returns>
        public T InsertAndGetEntity(T insertObj)
        {
        ...
        #region ExcuteSql
        public T ExcuteGetEntity(string sql, Dictionary<string, object> paramsDic)
        {
        ...
        /// <returns></returns>
        public List<T> ExcuteGetList(string sql, Dictionary<string, object> paramsDic)
        {
